  ...
  return (
    <section id="credentials" className="pt-4">
      ...
      <div className="mx-auto max-w-4xl px-6 pt-8 pb-16">
        ...
        <p className="mt-3 text-xs text-[var(--color-ink-soft)]/70 dark:text-[#8a8270]">{statsNote}</p>
        <div className="mt-6 flex flex-wrap gap-2">
          {badges.map((b, i) => (
            <span
              key={b}
              className="border-2 border-[var(--color-ink)] bg-[var(--color-paper)] px-3 py-1.5 text-sm font-bold dark:border-[#3a352a] dark:bg-[#1f1b14] dark:text-[#e8e2d3]"
